...
write.csv(lwh_fup2_household, here("outputs", "LWH_FUP2_households.csv"))
write.csv(lwh_fup2_plot_long, here("outputs", "LWH_FUP2_plots.csv"))

write.csv(lwh_fup2_food_long, here("outputs", "LWH_FUP2_food.csv"))
write.csv(lwh_fup2_assets_long, here("outputs", "LWH_FUP2_assets.csv"))
